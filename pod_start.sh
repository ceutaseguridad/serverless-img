...
if [ -d "$IPADAPTER_SOURCE_DIR" ]; then
    ...
    echo "[AVISO] Directorio de origen para IPAdapter no encontrado: $IPADAPTER_SOURCE_DIR. Creando directorio vacío."
...
if [ -d "$CONTROLNET_SOURCE_DIR" ]; then
    ...
    echo "[AVISO] Directorio de origen para ControlNet no encontrado: $CONTROLNET_SOURCE_DIR. Creando directorio vacío."
